...
from Scrapers.LibertaVoyagesScraper.scrap import scrap
...
create_table_query = '''
CREATE TABLE IF NOT EXISTS libertavoyages_src (
...
for destination in DESTINATIONS:
    ...
    df.to_sql('libertavoyages_src', engine, if_exists='append', index=False)
